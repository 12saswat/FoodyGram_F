...
const EditItem = () => {
  ...
  const fetchItem = async () => {
    try {
      const response = await axiosInstance.get(`/restaurant/items/${itemId}`);
  ...
  const handleSubmit = async (e) => {
    ...
    setSaving(true);
    try {
      await axiosInstance.put(`/restaurant/items/${itemId}`, {
        ...formData,
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Same form fields as AddItem but with pre-filled values */}
            <div>
